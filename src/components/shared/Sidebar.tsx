...
const Sidebar = () => {
  ...
  return (
    <div
      className={`absolute lg:static max-w-[288px] h-[88vh] md:h-[88vh] top-0 left-[0px] z-20 flex flex-col justify-between items-start pt-[20px] custom-transition opacity-100 bg-white`}
    >
        <button
